...
var applyRessources = function(src, dest, schema) {
...
var mapIndividus = function(situation) {
    return _.map(situation.individus, function(individu) {
        ...
        applyRessources(individu, target, ressourcesMap.individu);
        return target;
    });
};
...
var mapFamille = function(situation) {
    ...
    applyRessources({ ressources: ressources }, famille, ressourcesMap.famille);
