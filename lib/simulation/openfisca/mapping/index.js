...
var applyRessources = function(mesAidesEntity, openFiscaEntity, schema, dateDeValeur) {
...
var buildOpenFiscaEntity = function(src, schema, situation) {
    var result = {};
...
var mapIndividus = exports.mapIndividus = function (situation) {
    ...
    return _.map(individus, function(individu) {
        ...
        var openFiscaIndividu = buildOpenFiscaEntity(individu, ind, situation);
...
var mapFamille = function(situation) {
    var famille = buildOpenFiscaEntity(situation, fam, situation);
    var ressources = [];
...
var mapFoyerFiscal = exports.mapFoyerFiscal = function(situation) {
    var foyerFiscal = buildOpenFiscaEntity(situation, foy, situation);
    var ressources = [];
    _.forEach(situation.individus, function(individu) {
        ressources = ressources.concat(individu.ressources);
    });
...
exports.buildOpenFiscaRequest = function(situation, debug) {
        ...
        scenarios: [{
            test_case: {
                ...
                menages: [buildOpenFiscaEntity(situation, men, situation)]
            },
