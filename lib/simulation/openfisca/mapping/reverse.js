...
module.exports = function reverseMap(openFiscaResponse, situation) {
    ...
    return _.mapValues(PRESTATIONS, function(format, prestationName) {
        ...
        var type = format.type,
            computedPrestation = openfiscaResults[prestationName],
            result = computedPrestation[period];

        var uncomputabilityReason = openfiscaResults[prestationName + '_non_calculable'] && openfiscaResults[prestationName + '_non_calculable'][period];
