...
function createTestInYAML(situation, test) {
    ...
    testFileContent.familles.parents = testFileContent.familles.parents.map(function(id) {
        return id.toString();
    });
    testFileContent.familles.enfants = testFileContent.familles.enfants.map(function(id) {
        return id.toString();
    });
    testFileContent.foyers_fiscaux.declarants = testFileContent.foyers_fiscaux.declarants.map(function(id) {
        return id.toString();
    });
    testFileContent.foyers_fiscaux.personnes_a_charge = testFileContent.foyers_fiscaux.personnes_a_charge.map(function(id) {
        return id.toString();
    });
    testFileContent.menages.enfants = testFileContent.menages.enfants.map(function(id) {
        return id.toString();
    });
