...
exports.listInvalidated = function(req, res, next) {
    AcceptanceTest
...
exports.listWaiting = function(req, res, next) {
    AcceptanceTest
        .find({ validated: undefined })
        .populate('createdBy', '-password')
        .populate('derniereExecution', '-acceptanceTest -createdBy')
        .exec(function(err, acceptanceTests) {
        if (err) return next(err);
...
exports.validate = function(req, res, next) {
    req.acceptanceTest
        .set('validated', req.body.validated)
        .save(function(err) {
            if (err) return next(err);
            res.send(200);
        });
...
exports.setWaiting = function(req, res, next) {
    req.acceptanceTest
