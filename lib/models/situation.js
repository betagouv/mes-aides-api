...
var IndividuDef = {
    ...
    aCharge: Boolean,
    place: Boolean,
    residence: { type: String, enum: ['domicile_demandeur', 'garde_alternee', 'autre'] },
...
var LogementDef = {
    ...
    charges: Number,
    adresse: AdresseDef,
    type: { type: String, enum: ['locataire', 'proprietaire', 'gratuit', 'sansDomicile'] },
